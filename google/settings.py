...
SECRET_KEY = 'django-insecure-a%psfr99)))6-h*#^t9=rugy05cjn=iv_k%p#qiujdi4)dwz(i'
...
MIDDLEWARE = [
    ...
    'social_django.middleware.SocialAuthExceptionMiddleware', # this is google auth use
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'social_django.context_processors.backends',  # this is google auth use
